export const SCHEMA_SQL = [
  ...
  `CREATE INDEX IF NOT EXISTS idx_packer_adjustments_packer ON packer_adjustments (packer_operator_code)`,
  `CREATE INDEX IF NOT EXISTS idx_packer_adjustments_status ON packer_adjustments (status)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_packing_payment_drafts_status ON packing_payment_drafts (status)`,
  `CREATE INDEX IF NOT EXISTS idx_packing_payment_drafts_packer ON packing_payment_drafts (packer_operator_code)`,
  ...
  `CREATE INDEX IF NOT EXISTS idx_packing_payment_draft_sessions_session ON packing_payment_draft_sessions (packing_session_id)`,
